    ...
    public static void main (String [] args)
    {
        ...
        if (internetPackage.contains("a") || internetPackage.contains("A"))
        {
           ...
           if (hoursUsed >= 15)
           {
               if (hoursUsed == 15)
               {
                  System.out.println("We might suggest moving over to " +
                          "Package C. It would of cost the same \nbut" + 
                          " it would cover you incase you went over more" +
                          " than 15 hours."); 
               }
               else
                {
                    System.out.println("We might suggest moving over to " +
                            "Package C as this would of saved you $" + 
                            (total - 19.95));
                }
           }
           ...
           else if (hoursUsed >= 12)
           {
               if (hoursUsed == 12)
               {System.out.println("We might suggest moving over to " +
                          "Package B. It would of cost the same \nbut" + 
                          " it would cover you incase you went over more" +
                          " than 12 hours."); 
               }
               ...
               {
                   System.out.println("We might suggest moving over to " + 
                           "Package B as this would of saved you $" + 
                           (total - 13.95));
               }
           }
        }
